    ...
    internal class ProxyClass : MarshalByRefObject, IDisposable
    {
        ...
        public ProxyClass(string assemblyFile, string domainName, string configFile = null)
        {
            ...
            try
            {
                ...
                appDomainInfo.ApplicationBase     = Path;
                appDomainInfo.PrivateBinPath      = Path;
                appDomainInfo.PrivateBinPathProbe = Path;
                appDomainInfo.ShadowCopyFiles     = "true";
                appDomainInfo.LoaderOptimization  = LoaderOptimization.MultiDomainHost;
